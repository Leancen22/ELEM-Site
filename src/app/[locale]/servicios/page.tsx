...
const content: Record<Locale, Content> = {
  es: {
    ...
    detail: [
      ...
      { id: 'integraciones', title: 'Integraciones', body: 'Conectamos tus sistemas —ERP, CRM, pasarelas de pago y aplicaciones existentes— para que la información fluya sin errores ni datos duplicados.', points: ['Conexión de ERP y CRM', 'Pasarelas de pago', 'Sincronización fiable', 'Sin datos duplicados'] },
